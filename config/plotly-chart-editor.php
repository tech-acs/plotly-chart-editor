            ...
            'groups' => [
                ...
                'Hover' => [
                    ...
                    'fields' => [
                        ...
                        [
                            'key' => 'xhoverformat',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.xhoverformat',
                            'type' => 'text',
                        ],
                        [
                            'key' => 'yhoverformat',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.yhoverformat',
                            'type' => 'text',
                        ],
                    ],
                ],
            ...
            'groups' => [
                ...
                'Markers' => [
                    ...
                    'fields' => [
                        ...
                        [
                            'key' => 'marker.size_from_column',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.size_from_column',
                            'type' => 'boolean',
                            'dflt' => false,
                        ],
                        [
                            ...
                            'max' => 50,
                            'dflt' => 6,
                            'xshow' => '!trace.marker?.size_from_column',
                        ],
                        [
                            'key' => 'marker.size',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.size_column',
                            'type' => 'column',
                            'xshow' => 'trace.marker?.size_from_column',
                        ],
                        [
                            'key' => 'marker.sizemode',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.sizemode_bubble',
                            'type' => 'enumerated',
                        ...
                        [
                            'key' => 'marker.sizeref',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.sizeref',
                            'type' => 'number',
                            'min' => 0,
                            'dflt' => 1,
                            'xshow' => 'trace.marker?.size_from_column',
                        ...
                        [
                            'key' => 'marker.sizemin',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.sizemin',
                            'type' => 'number',
                            'min' => 0,
                            'dflt' => 0,
                            'xshow' => 'trace.marker?.size_from_column',
                ...
                'Sectors' => [
                    ...
                    'fields' => [
                        ...
                        [
                            ...
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.textposition',
                            'type' => 'enumerated',
                            'values' => ['auto', 'inside', 'outside', 'none'],
                            'dflt' => 'auto',
                        ],
                        [
                            'key' => 'textfont.family',
            ...
            'groups' => [
                'Data' => [
                    ...
                    'fields' => [
                        ...
                        [
                            'key' => 'parents',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.parents',
                            'type' => 'column',
                        ],
                        [
                            'key' => 'values',
                ...
                'Sectors' => [
                    ...
                    'fields' => [
                        [
                            'key' => 'branchvalues',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.branchvalues',
                            'type' => 'enumerated',
                        ...
                        [
                            ...
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.textinfo',
                            'type' => 'enumerated',
                            'values' => ['label', 'text', 'value', 'percent', 'percent root', 'percent entry', 'percent parent', 'label+text', 'label+value', 'label+percent', 'label+percent root', 'label+percent entry', 'label+percent parent', 'none'],
                            'dflt' => 'label+percent',
                        ],
                        [
                            'key' => 'textfont.family',
                        ...
                        [
                            'key' => 'insidetextorientation',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.insidetextorientation',
                            'type' => 'enumerated',
                            'values' => ['auto', 'radial', 'tangential', 'horizontal'],
                            'dflt' => 'auto',
                        ],
                        [
                            'key' => 'maxdepth',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.maxdepth',
                            'type' => 'number',
                            'min' => 1,
                            'dflt' => 3,
                        ],
                ...
                'Markers' => [
                    ...
                    'fields' => [
                        [
                            'key' => 'marker.colors',
                            'label' => 'plotly-chart-editor::plotly-chart-editor.fields.colors',
                            'type' => 'column',
                        ],
                        [
                            'key' => 'marker.line.color',
